...
class _OnboardingScreenState extends State<OnboardingScreen> {
  ...
  final _slides = const [
    ...
    _OnboardingSlide(
      ...
      subtitle:
          'Farm Flow uses your location to show products and farmers near you. This ensures the freshest produce with minimal transit.',
      subtitleTa:
          'பாம் ப்ளோ உங்கள் இருப்பிடத்தைப் பயன்படுத்தி உங்களுக்கு அருகிலுள்ள தயாரிப்புகளையும் விவசாயிகளையும் காட்டுகிறது. இது குறைந்த போக்குவரத்து மற்றும் புதிய விளைபொருட்களை உறுதி செய்கிறது.',
    ),
  ];
  ...
  Future<void> _finish() async {
    ...
    // Navigate to role preview screen
    if (mounted) {
      Navigator.pushReplacementNamed(context, '/role_preview');
    }
  }
