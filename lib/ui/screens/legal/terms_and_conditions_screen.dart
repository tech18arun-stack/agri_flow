    ...
    if (_isTamil) {
      ...
      return [
        _buildSection(
          ...
          content: 'By accessing or using AgriFlow ("the App"), you agree to be bound by these Terms and Conditions. If you do not agree to these terms, do not use the App.\n\n'
              'AgriFlow is a digital agricultural marketplace platform designed to connect farmers, customers, and merchants in Tamil Nadu, India.\n\n'
        ...
        _buildSection(
          ...
          content: '4.1 Product Listings\n'
              ...
              '4.2 Transactions\n'
              '• All transactions are between users; AgriFlow is a platform provider\n'
              '• Payment terms are agreed between buyer and seller\n'
              '• AgriFlow does not guarantee transaction completion\n\n'
              '4.3 Commission and Fees\n'
              '• AgriFlow may charge commissions or fees for platform use\n'
        ...
        _buildSection(
          ...
          content: 'For questions about these Terms and Conditions:\n\n'
              ...
              'Address: AgriFlow, Tamil Nadu, India\n\n'
