    ...
    return Scaffold(
      body: CustomScrollView(
        slivers: [
              ...
              IconButton(
                icon: Container(
                  ...
                  child: Icon(
                    ...
                    color:
                        wishlist.isInWishlist(p.id) ? Colors.red : Colors.white,
                  ),
                ),
                onPressed: () {
                  ...
                  ScaffoldMessenger.of(context).showSnackBar(
                    SnackBar(
                      content: Text(wishlist.isInWishlist(p.id)
                          ? 'Added to wishlist'
            ...
            flexibleSpace: FlexibleSpaceBar(
              background: Container(
                ...
                child: p.imageUrl != null && p.imageUrl!.isNotEmpty
                    ...
                    : Center(
                        child: Icon(Icons.eco,
                            size: 80, color: C.primary.withValues(alpha: 0.3)),
                      ),
              ),
            ),
          ),
          ...
          SliverPadding(
            padding:
                Responsive.padH(context, 16).copyWith(top: 16, bottom: 100),
            sliver: SliverList(
              delegate: SliverChildListDelegate([
                  ...
                  children: [
                    if (p.organic)
                      Container(
                        ...
                        decoration: BoxDecoration(
                            color: C.tertiaryFixed.withValues(alpha: 0.2),
                            borderRadius: BorderRadius.circular(8)),
                        child: const Row(
                            mainAxisSize: MainAxisSize.min,
                            children: [
                              Icon(Icons.eco,
                                  size: 14, color: Color(0xFF1a2800)),
                              SizedBox(width: 4),
                              Text('Organic',
                                  style: TextStyle(
                                      fontSize: 11,
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                          ...
                          borderRadius: BorderRadius.circular(8)),
                      child: Text(
                          '${p.category.toUpperCase()} • ${p.quantity} ${p.unit} available',
                          style: TextStyle(
                              fontSize: 11, fontWeight: FontWeight.w600)),
                    ),
                  ],
                ...
                Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            Text('Verified Farmer • ${p.location}',
                                style: TextStyle(
                      ...
                      IconButton(
                        onPressed: () async {
                          if (p.farmerPhone != null &&
                              p.farmerPhone!.isNotEmpty) {
                            ...
                            ScaffoldMessenger.of(context).showSnackBar(
                              const SnackBar(
                                  content:
                                      Text('Farmer contact not available')),
                            );
                          }
                        },
                        icon: Container(
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                            color: C.primaryFixed.withValues(alpha: 0.2),
                            borderRadius: BorderRadius.circular(8)),
                        child: Row(children: [
                ...
                Text(
                    'Fresh ${p.name} ${p.nameTa.isNotEmpty ? " | ${p.nameTa}" : ""} harvested from verified farms in ${p.location}. Quality checked and ready for delivery.',
                    style: TextStyle(
                        fontSize: 13, color: C.onSurfaceVariant, height: 1.6)),
                const SizedBox(height: 20),

                // Price Comparison (if products available)
                Consumer<ProductProvider>(
                  builder: (context, productProv, _) {
                    final similar = productProv.all
                ...
                child: ElevatedButton.icon(
                  onPressed: () {
                    ...
                    ScaffoldMessenger.of(context).showSnackBar(
                      SnackBar(
                          content: Text(
                              'Added $_quantity ${p.name} ${p.nameTa.isNotEmpty ? "| ${p.nameTa}" : ""} to cart')),
                    );
                  },
