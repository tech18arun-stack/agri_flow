...
class ConfigService {
  ...
  static const String githubConfigUrl = 
      'https://raw.githubusercontent.com/tech18arun-stack/Farm Flow_config/refs/heads/main/config.json';
  ...
  void _applyConfig(Map<String, dynamic> config) {
    ...
    if (collections != null) {
      ...
      AppwriteConfig.harvestPreviewsCollectionId = collections['harvest_previews'] ?? '';
